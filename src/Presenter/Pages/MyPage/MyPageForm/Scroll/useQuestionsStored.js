 ...
 */
const useQuestionsStored = (pageNumber, idToken) => {
   ...
   */
  const dropScrapQuestion = async (id, update) => {
    setLoading(true);
    setError(false);
  ...
  return { loading, error, dataList, hasMore, dropScrapQuestion, voteQuestion };
};

export default useQuestionsStored;
