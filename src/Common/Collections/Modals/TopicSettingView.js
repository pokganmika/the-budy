...
function TopicSettingView({
  ...
  const _closeTopicSetting = closeTopicSetting || function() {};
  ...
  return (
    <View>
      <Header>
        <div className="closeBtn" onClick={_closeTopicSetting}>
          <span className="budy-chevron-left" />
          <span className="label">Back</span>
        </div>
        <div className="title">{_headerTitle}</div>
        <div className="caption">{`Add topic tags to your new ${postType ||
          'question'} post.`}</div>
      </Header>
      <Wrapper>
        <TopicSearchInput
...
export default TopicSettingView;
